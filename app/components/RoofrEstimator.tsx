...
export default function RoofrEstimator() {
  return (
    <section className="flex flex-col items-center gap-8 h-[1000px] md:h-auto px-5 md:px-10 py-10">
      ...
      <div className="w-full md:h-auto h-[800px] md:max-w-[1000px] rounded-xl lg:rounded-[35px] overflow-hidden shadow-2xl">
