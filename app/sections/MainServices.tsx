    ...
    <section className="flex flex-col items-center p-6 lg:pb-16 gap-6 lg:px-12 h-full w-full max-w-[1400px] z-10">
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="grid grid-cols-3 grid-rows-1 gap-7">
          <MainMenuCard title="Roof" image="/images/home_bg.png" />
          <MainMenuCard title="Siding" image="/images/home_bg.png" />
          <MainMenuCard title="Window" image="/images/home_bg.png" />
        </div>
      </div>
      <div className="flex flex-col gap-5 w-full">
        <div className="flex flex-row items-center gap-5">
        ...
        <div className="grid grid-cols-3 grid-rows-1 gap-7">
          <MainMenuCard title="Bathrooms" image="/images/home_bg.png" />
          <MainMenuCard title="Kitchen" image="/images/home_bg.png" />
          <MainMenuCard title="General Painting" image="/images/home_bg.png" />
        </div>
      </div>
    </section>
  );
